...
<a name='due'></a>
## 1. Due Date 
**11:59:59 PM, February 15, 2026. This homework is to be done individually and NO LATE DAYS ARE ALLOWED.**
...
printed on an A4 paper and the size of each square was 21.5mm. Note that the $$Y$$ axis has odd number of squares and $$X$$ axis has even number of squares. It is a general practice to neglect the outer squares (the row and columns of squares on the edges of the checkerboard). For example, if you have a $$5\times8$$ grid, you'll only consider the inner $$3\times6$$ grid for computation. **Again, this is not necessary but a common practice.** Thirteen images taken from a Google Pixel XL phone with focus locked can be downloaded from [here](https://app.box.com/s/z18zwbs11609z988x0kod3o1058rdop5) which you will use to calibrate.
